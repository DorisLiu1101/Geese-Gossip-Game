...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-green-50 to-yellow-50 relative overflow-hidden">
      <div className="absolute inset-0 opacity-10 pointer-events-none bg-[radial-gradient(circle_at_50%_120%,#7CB342_0%,transparent_50%)]"></div>
      <div className="absolute top-0 left-0 w-64 h-64 bg-green-400 rounded-full blur-3xl opacity-10 -translate-x-1/2 -translate-y-1/2"></div>
